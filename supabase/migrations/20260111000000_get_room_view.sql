-- ============================================================================
-- subasta — public read-only snapshot of any room (spectator mode)
-- ============================================================================
-- Anyone with the room code can fetch a read-only snapshot of the current
-- room state — the same shape the load function uses, but bypasses RLS.
-- Used by /room/[code] when the caller is not a member, so spectators can
-- watch a draft live (with client-side polling for updates).
--
-- Returns NULL if the code doesn't match any room.
-- ============================================================================
