-- Add `team` (from player.metadata->>'team') to upcoming_auctions in get_room_view.
-- Lets the UI disambiguate same-named players across different historic seasons
-- (e.g. two Juan Román Riquelmes from Villarreal 05-06 vs 07-08).
